...
<link href="logincss/style1.css" rel="stylesheet" type="text/css" media="all"/><!--stylesheet-css-->
...
<div class="w3l-main">
	<div class="w3l-from">
		...
		<br>
		<div>
					<h4><p align="center" style="color:red;">username&password successfullly send to yourmail<p></h4>
					</div>
	<br>
					<div class="text-center p-t-12" align="center" style="color:white;">
					<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
					...
					Forgot
					<a href="Login.jsp"  style="color:white;"> Username/Password</a>
							</div>
	</div>
</div>
