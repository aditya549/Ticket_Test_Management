	...
	<div class="w3l-from">
		<form action="LoginServlet" method="post">	
			...
			<div class="btn">
				...
				<p  style="color:red;">&ensp;&ensp;&ensp;&ensp;&ensp;x  Invalid Username or Password<p>	
				</div><br>
			<div class="w3l-rem" align="right" style="color:white">Forgot:
					<a href="Forgot.jsp" style="color:white">username/password</a>
							</div>
			</div>
